...
cd = pd.read_pickle("metagenomic_scripts/metagenomic_data_files/Poyet_collection_dates.pkl")
df = pd.read_csv("metagenomic_scripts/metagenomic_data_files/Poyet_SRA_report.txt",sep="\t",index_col=3)

hosts = ["am","an","ae","ao"]

df=pd.read_csv("metagenomic_scripts/metagenomic_data_files/Poyet_SRA_report.txt",index_col=0,sep="\t")
...
pd.Series(repeat_dic).to_pickle("metagenomic_scripts/metagenomic_data_files/Poyet_repeat_day_samples.pkl")